...
function populateFilters() {
  ...
  document.getElementById('filterCustomer').innerHTML = '<option value="">All customers</option>' + customers.map(c => `<option>${c}</option>`).join('');
}
